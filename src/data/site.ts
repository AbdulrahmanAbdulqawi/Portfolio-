...
export const siteConfig: Record<'en' | 'ar', SiteConfig> = {
  en: {
    ...
    homeIntro: 'I\'m a software developer based in the Netherlands. I build backend systems, APIs, and web apps with .NET and React. Explore the sections below to learn more.',
  ...
  ar: {
    ...
    homeIntro: 'أنا مطور برمجيات مقيم في هولندا. أبني أنظمة خلفية وواجهات برمجة وتطبيقات ويب باستخدام .NET و React. استكشف الأقسام أدناه للمزيد.',
    email: 'abdulrahmanabdulqawi76@gmail.com',
    phone: '+31687269021',
